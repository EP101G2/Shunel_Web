...
//	}
	...
	public Order_Main(int order_ID, String account_ID, int order_Main_Total_Price, String order_Main_Recriver,
		...
		this.order_Main_Receiver = order_Main_Recriver;
	...
	public Order_Main(int order_ID, int status, int totalPrice, String receiver, String address, String phone) {
		// TODO Auto-generated constructor stub
	}
	...
	public void setOrder_Main_Order_Status(int order_Main_Order_Status) {
		order_Status = order_Main_Order_Status;
	}
